            ...
            <nav className="border-b border-gray-100 bg-white">
                    ...
                    <div className="flex h-16 justify-between">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink href="/chat" active={page.url.startsWith("/chat")}>
                                    社内AIチャット
                                </NavLink>
                                <NavLink href="/skills" active={page.url.startsWith("/skills")}>
                                    スキル
                                </NavLink>
                                <NavLink href="/usage" active={page.url.startsWith("/usage")}>
                                    利用状況
                                </NavLink>
                            </div>
                        </div>
                ...
                <div className={`${showingNavigationDropdown ? "block" : "hidden"} sm:hidden`}>
                    <div className="space-y-1 pb-3 pt-2">
                        ...
                        <ResponsiveNavLink href="/chat" active={page.url.startsWith("/chat")}>
                            社内AIチャット
                        </ResponsiveNavLink>
                        <ResponsiveNavLink href="/skills" active={page.url.startsWith("/skills")}>
                            スキル
                        </ResponsiveNavLink>
                        <ResponsiveNavLink href="/usage" active={page.url.startsWith("/usage")}>
                            利用状況
                        </ResponsiveNavLink>
                    </div>
